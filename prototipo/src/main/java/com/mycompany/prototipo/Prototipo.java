...
public class LOGIN_Trabajadores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(83, 107, 120));
        ...
        txt_usuario.setBackground(new java.awt.Color(83, 107, 120));
        ...
        txt_password.setBackground(new java.awt.Color(83, 107, 120));
        ...
        Pnl_barraSuperior.setBackground(new java.awt.Color(83, 107, 120));
        ...
        Pnl_salir.setBackground(new java.awt.Color(83, 107, 120));
        ...
        Lbl_marca.setText("Trabajadores®");
    ...
    private void Pnl_barraSuperiorMousePressed(java.awt.event.MouseEvent evt) {                                               
        xMouse = evt.getX();
        yMouse = evt.getY();
    }                                              

    private void Pnl_barraSuperiorMouseDragged(java.awt.event.MouseEvent evt) {                                               
        int x = evt.getXOnScreen();
        int y = evt.getYOnScreen();
        this.setLocation(x - xMouse, y - yMouse);
    }                                              

    private void Btn_salirMouseExited(java.awt.event.MouseEvent evt) {                                      
        procesoRepetido.pintarComponente("tLogin", Pnl_salir);
    }                                     

    private void Btn_salirMouseEntered(java.awt.event.MouseEvent evt) {                                       
    ...
    private void Btn_iniciarSesionMouseEntered(java.awt.event.MouseEvent evt) {                                               
        procesoRepetido.pintarComponente("sVerde", Pnl_iniciarSesion);
    }                                              

    private void Btn_iniciarSesionMouseExited(java.awt.event.MouseEvent evt) {                                              
        procesoRepetido.pintarComponente("dsVerde", Pnl_iniciarSesion);
    }                                             

    private void Btn_iniciarSesionMouseClicked(java.awt.event.MouseEvent evt) {                                               
        ...
        if (newPassword.equals(login.getPassword())) {
            idUsuario=login.getIdTrabaajdor();
            nomUsuario=login.getNombre()+" "+login.getApellido();
            MDI_Trabajadores mdiTrabajadores = new MDI_Trabajadores();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LOGIN_Trabajadores().setVisible(true);
            }
        });
    }
